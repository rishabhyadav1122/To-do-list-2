...
function playCompletionSound() {
  var sound = new Audio('./music/task-comp.mp3');
  sound.play();
}
...
function CreateToDoItems () {
    ...
    else 
    {
      ...
      return;
        ...
        const todoItems = `
        <div title="Hit Click and Complete" onclick="CompletedToDoItems(this)">
            ${todoValue.value}
        </div>
          <div>
  ...
  function ReadToDoItems() {
    todo.forEach((element) => {
      ...
      const todoItems = `<div ${style} title="Hit  Click and Complete" onclick="CompletedToDoItems(this)">${
        element.item
      }
      ${
        style === ""
